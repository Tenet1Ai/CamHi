...
typedef struct
{
    HI_U32 u32Enable;	/*0 关闭RF报警  1 开启RF报警*/
}HI_P2P_IPCRF_ENABLE;
/**********************HI_P2P_IPCRF_ALARM_GET**********************/

/********************HI_P2P_IPCRF_SINGLE_INFO_GET******************/
#define HI_P2P_IPCRF_SENSOR_TYPE_KEY_0      "key0"  //遥控按键0
#define HI_P2P_IPCRF_SENSOR_TYPE_KEY_1      "key1"  //遥控按键1
#define HI_P2P_IPCRF_SENSOR_TYPE_KEY_2      "key2"  //遥控按键2
#define HI_P2P_IPCRF_SENSOR_TYPE_KEY_3      "key3"  //遥控按键3
#define HI_P2P_IPCRF_SENSOR_TYPE_DOOR       "door"  //门磁
#define HI_P2P_IPCRF_SENSOR_TYPE_INFRA      "infra" //红外
#define HI_P2P_IPCRF_SENSOR_TYPE_BEEP       "beep"  //门铃
#define HI_P2P_IPCRF_SENSOR_TYPE_FIRE       "fire"  //烟雾
#define HI_P2P_IPCRF_SENSOR_TYPE_GAS        "gas"   //燃气
#define HI_P2P_IPCRF_SENSOR_TYPE_SOCKET     "socket"//插座
#define HI_P2P_IPCRF_SENSOR_TYPE_TEMP       "temp"  //温度
#define HI_P2P_IPCRF_SENSOR_TYPE_HUMI       "humi"  //湿度

typedef struct
{
    HI_U32 u32Index;		/*IPCRF 序号1-16*/
    HI_U32 u32Enable;		/*IPCRF 是否启用*/
    HI_CHAR sRfCode[16];	/*IPCRF 模块码值*/
    HI_CHAR sType[16];		/*IPCRF 类型，上面的宏定义*/
    HI_CHAR sName[64];		/*IPCRF 名称，用户自定义*/
} HI_P2P_IPCRF_INFO;
/********************HI_P2P_IPCRF_SINGLE_INFO_GET******************/
...
typedef struct
{
    HI_P2P_IPCRF_INFO sRfInfo[HI_P2P_IPCRF_MAXNUM];
...
/********************新增2016.06.07******************/
#define HI_P2P_GET_UUID_CRCKEY			0x0000413c		/*获取uuid+srckey，仅供测试用*/

//#define HI_P2P_TEMP_HUMIDITY_CTRL		0x00004140		/*未完成——温湿度控制(显示/隐藏)*/

/**新增2016.10.13(测试阶段)   有HI_P2P_PB_QUERY_START_NEW修改时区不再需要重启**/
#define HI_P2P_PB_QUERY_START_NEW		0x0000413d		/*获取录像列表(按时间)*/
#define HI_P2P_PB_QUERY_START_FILE		0x0000414e		/*获取录像列表(按文件名     按时间降序) */

/************新增2016.10.18  RF报警、温湿度报警**********/
#define HI_P2P_IPCRF_ALARM_GET			0x0000414f		/*获取RF报警状态*/
#define HI_P2P_IPCRF_ALARM_SET			0x00004150		/*RF报警开关设置*/
#define HI_P2P_IPCRF_SINGLE_INFO_GET	0x00004151		/*单个RF参数获取*/
#define HI_P2P_IPCRF_SINGLE_INFO_SET	0x00004152		/*单个RF参数设置*/
#define HI_P2P_IPCRF_ALL_INFO_GET    	0x00004153		/*所有RF参数获取*/
#define HI_P2P_IPCRF_CAPTURE			0x00004154		/*开始RF对码，并获取码值，此处会超时等待(60s)*/
#define HI_P2P_TEMPERATURE_ALARM_GET	0x00004155		/*获取温度报警范围*/
#define HI_P2P_TEMPERATURE_ALARM_SET	0x00004156		/*设置温度报警范围*/
#define HI_P2P_HUMIDITY_ALARM_GET		0x00004157		/*获取湿度报警范围*/
#define HI_P2P_HUMIDITY_ALARM_SET		0x00004158		/*设置湿度报警范围*/
