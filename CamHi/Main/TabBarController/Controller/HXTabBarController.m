...
- (void)setupChildControllers {
    ...
    [self.controllers addObject:[MController initWithName:@"CameraViewController" title:@"Camera" navigationTitle:@"Camera" tabbarImage:@"tabbar_camera" tabbarImageSelect:@"tabbar_cameraclick"]];
    [self.controllers addObject:[MController initWithName:@"PhotoViewController" title:@"Picture" navigationTitle:@"Picture" tabbarImage:@"tabbar_picture" tabbarImageSelect:@"tabbar_pictureclick"]];
    [self.controllers addObject:[MController initWithName:@"VideoViewController" title:@"Video" navigationTitle:@"Video" tabbarImage:@"tabbar_video" tabbarImageSelect:@"tabbar_videoclick"]];
    [self.controllers addObject:[MController initWithName:@"AboutViewController" title:@"About" navigationTitle:@"About" tabbarImage:@"tabbar_about" tabbarImageSelect:@"tabbar_aboutclick"]];
    
    //NSLog(@"controllers : %@", self.controllers);
    [self.controllers enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        [self setupChildControllerWithModel:(MController *)obj];
    }];

}


- (void)setupChildControllerWithModel:(MController *)mcontroller {
    
    UIViewController *controller = [[NSClassFromString(mcontroller.className) alloc] init];
    
    controller.title = NSLocalizedString(mcontroller.classTitle, nil);
    controller.navigationItem.title = NSLocalizedString(mcontroller.navigationTitle, nil);
    controller.tabBarItem.image = [UIImage imageNamed:mcontroller.tabbarImage];
    //controller.tabBarItem.image = [[UIImage imageNamed:mcontroller.tabbarImage] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    ...
    HXNavigationController *nvcontroller = [[HXNavigationController alloc] initWithRootViewController:controller];
    
    [self addChildViewController:nvcontroller];
